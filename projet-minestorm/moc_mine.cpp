...
const QMetaObject Mine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Mine.data,
      qt_meta_data_Mine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Mine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Mine.stringdata))
