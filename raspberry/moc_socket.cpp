...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Socket_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 55, 12) // "disconnected"

    },
    "Socket\0receiveMessage\0\0msg\0"
    "socketDisconnected\0readData\0disconnected"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->receiveMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (Socket::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Socket::receiveMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (Socket::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Socket::socketDisconnected)) {
                *result = 1;
            }
        }
    }
...
void *Socket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Socket.stringdata))
...
// SIGNAL 0
void Socket::receiveMessage(const QString & _t1)
{
